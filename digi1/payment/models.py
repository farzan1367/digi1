...
class Order(models.Model):
    ...
    # data_ordered = jmodels.jDateTimeField(auto_now_add=True)
    # update_order = jmodels.jDateTimeField(auto_now=True)
    ...
    update_order = models.DateTimeField(auto_now=True)

    # def save(self, *args, **kwargs):
    #     # if self.pk:
    #     #     old_status = Order.objects.get(id=self.pk).status
    #     #     if old_status != self.status:
    #     #         self.update_order = datetime.datetime.now()
